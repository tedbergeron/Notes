...
==== Asciidoctor-Chrome Extensions

* link:https://chrome.google.com/webstore/detail/asciidoctorjs-live-previe/iaalpfgpbocpdfblpnhhgllgbdbchmia?utm_source=chrome-app-launcher-info-dialog[Asciidoctor.js Live Preview]
* link:https://chrome.google.com/webstore/detail/copy-as-asciidoc/kabphjofkinmakglobecmbgpbopknobc?utm_source=chrome-app-launcher-info-dialog[Copy as AsciiDoc]
...
NOTE: Interesting article on https://www.linkedin.com/pulse/ebook-publishing-template-toolchain-jon-archer[eBook publishing template and toolchain | Jon Archer]
